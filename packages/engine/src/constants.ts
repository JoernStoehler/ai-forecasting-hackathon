...
- Timeline lines include events (news-published, hidden-news-published, turn-started/finished) plus a forecast cutoff marker:
...
- For "publish-news": { "type": "publish-news", "date": "YYYY-MM-DD", "icon": "LucideIconName", "title": "string", "description": "string", "id"?: "string" }.
- For "publish-hidden-news": { "type": "publish-hidden-news", "date": "YYYY-MM-DD", "icon": "LucideIconName", "title": "string", "description": "string", "id"?: "string" }.
- For "patch-news": { "type": "patch-news", "id": "string", "date": "YYYY-MM-DD", "patch": { "date"?: "YYYY-MM-DD", "icon"?: "LucideIconName", "title"?: "string", "description"?: "string" } }.
...
- If you may patch an event later, include a stable "id" when publishing it.
