...
- **Timeline body** — Events render in chronological order with sticky year and month markers, a left gutter that houses icons, and expandable descriptions. Hidden news entries are filtered out for now so the public timeline stays forward-facing.
